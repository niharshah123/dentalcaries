<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consultation.aspx.cs" Inherits="consultation" %>
   ...
   <div id="page">
			...
			<div id="content">
				...
				<ul class="navigation">
					...
					<li id="link2"><a href="Signs & Symptoms.html">Signs & Symptoms</a></li>
					<li  class="selected" id="link3"><a href="Preventions.html">Preventions</a></li>
				</ul>
				<div id="figure">
				...
				<div id="section">
					<div id="article">
						...
						<p><b>Call us : 117-683-9187-000</b></p>
						<p><b>Email us : company@email.com</b></p>
					</div>
					<ul id="buttons">
