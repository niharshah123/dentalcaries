<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionSubmission.aspx.cs" Inherits="QuestionSubmission" %>
        ...
        <div id="page">
			...
			<div class="content">
				...
				<div>
					...
					<p><b> Your question is 
					       submitted successfully!!</b></p>
					...
					<form action="" method="">
						<table cellspacing="10">
							<tbody>
								<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
								<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
								<tr><td class="concern">&nbsp;</td><td>&nbsp;</td></tr>
								<tr><td colspan="2" align="right" class="auto-style1"></td></tr>
							</tbody>
						</table>
					</form>
				</div>
