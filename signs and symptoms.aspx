<%@ Page Language="C#" AutoEventWireup="true" CodeFile="signs and symptoms.aspx.cs" Inherits="signs_and_symptoms" %>
    ...
    <div id="page">
			...
			<div id="content">
				...
				<ul class="navigation">
					...
					<li class="selected" id="link2"><a href="Signs & Symptoms.aspx">Signs & Symptoms</a></li>
				...
				<div id="section">
					<div id="article">
						...
						<div class="cosmetics">
							<p>The signs and symptoms of cavities vary, depending on their extent and location. When a cavity is just beginning, 
							   you may not have any symptoms at all. As the decay gets larger, it may cause signs and symptoms such as:</p>
							<ol>
							<font color= "white">
							<li>  Toothache,spontaneous pain or pain that occurs without any apparent cause. </li>
							    <li>  Tooth sensitivity. </li>
								<li>  Mild to sharp pain when eating or drinking something sweet, hot or cold. </li>
