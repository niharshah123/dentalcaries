<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Question - Copy.aspx.cs" Inherits="Question" %>
...
<div id="page">
			...
			<div class="content">
				<div class="navigation">
					<ul>
						...
						<li id="link3"><a href="Preventionsaspx">Preventions</a></li>
					</ul>
					<ul id="buttons">
						<li><a href="check-up.aspx">book a check-up</a></li>
						
						<li class="selected"><a href="Question.aspx">ask a question</a></li>
					</ul>
						...
						<table cellspacing="10">
							<tbody>
								<tr><td><label>
                                    ...
                                    <asp:TextBox ID="TextBox3" runat="server" Height="25px" Width="298px"></asp:TextBox>
                                    </td></tr>
								<tr><td><label>
                                    <asp:Label ID="Label2" runat="server" Text="Last Name"></asp:Label>
                                    </label>
                                    </td><td>
                                    <asp:TextBox ID="TextBox2" runat="server" Height="25px" Width="298px"></asp:TextBox>
                                    </td></tr>
                                <tr><td><label>
                                    <asp:Label ID="Label3" runat="server" Text="Email"></asp:Label>
                                    </label>
                                    </td><td>
                                    <asp:TextBox ID="TextBox4" runat="server" Height="25px" Width="298px"></asp:TextBox>
         ...
         ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
								...
								<tr><td class="concern"><label>
                                    <asp:Label ID="Label4" runat="server" Text="Concern"></asp:Label>
                                    </label>
                                    </td><td>
                                    <asp:TextBox ID="TextBox1" runat="server" Height="109px" Width="298px" TextMode="MultiLine"></asp:TextBox>
                                    </td></tr>
								<tr><td colspan="2" align="right">
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [AskQuestion]"></asp:SqlDataSource>
