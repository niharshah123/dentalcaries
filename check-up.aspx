<%@ Page Language="C#" AutoEventWireup="true" CodeFile="check-up.aspx.cs" Inherits="check_up" %>
    ...
    <div id="page">
			...
			<div class="content">
				...
				<div>
					...
					<p><b>Call Us : 807-000-0000</b></p>
					<p><b>Email Us : Dentalsolutions1001@gmail.com</b></p>
					<p><b>Fill Up Form</b></p>
					<form action="" method="">
						<table cellspacing="10">
							<tbody>
								<tr><td><label>First Name</label></td><td><input type="text" class="txtfield" /></td></tr>
								<tr><td><label>Last Name</label></td><td><input type="text" class="txtfield" /></td></tr>                             
								<tr><td><label>Contact No</label></td><td><input type="text" class="txtfield" /></td></tr>
								<tr><td><label>E-mail</label></td><td><input type="text" class="txtfield" /></td></tr>
